...
description: 从文件或 URL 导入 instinct 到项目/全局范围
command: true
---
...
- `--dry-run`：预览而不导入
- `--force`：跳过确认提示
- `--min-confidence <n>`：仅导入高于阈值的 instinct
